...
- DL-2026-06-002 — Use Figma for design instead of Sketch (accepted)
- DL-2026-06-003 — Use RudderStack as CDP instead of Segment (accepted)
- DL-2026-06-004 — Use Postgres as primary database instead of MongoDB
  (accepted)
- DL-2026-06-005 — Use Linear for issue tracking instead of Jira
  (accepted)
...
since DL-2026-06-001 — new requirements, changed constraints, or a
...
CONSTRAINT
DL-2026-06-003 — Use RudderStack as CDP instead of Segment (accepted)
Your onboarding flow will need to use RudderStack as the data source
for user events. This limits which analytics properties are available
for onboarding segmentation to what RudderStack captures.

CLEAR
No conflicts found for: design tooling, issue tracking workflow.
```
...
The proposal to build in-house directly contradicts DL-2026-06-001,
...
DL-2026-06-001 directly address the same trade-off.

**Why DEPENDENCY appears instead of CONFLICT for Postgres:**
The proposal is consistent with DL-2026-06-004, not contradicting it.
